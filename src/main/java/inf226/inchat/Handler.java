...
public class Handler extends AbstractHandler
{
    ...
    throws IOException, ServletException
  {
    ...
    try {
        ...
        response.setHeader("Set-Cookie", "session=" + session.identity.toString() + "; HttpOnly; Secure; SameSite=strict");
        response.setHeader("Content-Security-Policy", "script-src 'self';");


        //TODO: trenger vi både line 140 og 141? (141 er den sikre implementajsonen av cookies)
    ...
    private void printStandardHead(PrintWriter out, String title) {
        ...
        //out.println("<meta http-equiv="Content-Security-Policy" content="script-src 'self'">");
